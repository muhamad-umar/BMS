-- Baseline Migration (Manual Dump)
-- As `supabase db pull` could not be executed non-interactively in this environment, 
-- this baseline captures the existing functions, views, and triggers. 
-- Please run `supabase db pull` to complete the baseline with table structures.
